 ...
 * that are sometimes caused when recognition performance is poor and some points on the lips aren't recognized
 * properly.
...
public class SkippedFramesNormalizer implements Normalizer
{
    ...
    private void putIntermidiates(int startIndex, int stopIndex, LipVideoSample sample)
    {
