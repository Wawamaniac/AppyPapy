...
public interface Normalizer
{
     ...
     * @postcondition sample`s normalized data contains the same needed classification data. In other words -
     * normalization process should not damage Sample`s data
     */
